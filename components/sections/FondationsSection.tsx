...
export function FondationsSection() {
  return (
    <section className="py-20 bg-white relative overflow-hidden" id="fondations">
      ...
      <div
        ...
        aria-hidden="true"
      />
      <div className="absolute bottom-0 left-0 right-0 h-[1px] bg-gray-100" aria-hidden="true" />
      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="font-barlow-condensed font-extrabold text-4xl sm:text-5xl md:text-6xl text-gray-900 uppercase mb-5 leading-tight">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-14">
          ...
          >
            <div className="flex items-center gap-3 mb-6">
              ...
              <h3 className="font-barlow-condensed font-bold text-xl text-gray-900 uppercase">
        ...
        >
          ...
          <div className="flex-1">
            ...
            <h4 className="text-gray-900 font-barlow-condensed font-bold text-xl uppercase mb-2">
