      ...
      <div className="container mx-auto px-4">
            ...
            return (
              ...
              >
                <Link href={`/services/${service.slug}`} className="group block h-full">
                  <div className="h-full bg-white rounded-2xl p-7 border border-transparent hover:border-[#D97706]/30 hover:shadow-lg hover:shadow-[#D97706]/5 transition-all duration-300">
                    {/* Icône */}
                    <div className="w-11 h-11 rounded-xl bg-[#D97706]/10 group-hover:bg-[#D97706] flex items-center justify-center mb-5 transition-colors duration-300">
                      <Icon className="w-5 h-5 text-[#D97706] group-hover:text-white transition-colors duration-300" aria-hidden="true" />
                    </div>
                    {/* Titre */}
                    <h3 className="font-barlow-condensed font-bold text-lg text-[#1C2B3A] group-hover:text-[#D97706] uppercase mb-2 transition-colors">
                      {service.title}
                    </h3>
                    {/* Description */}
                    ...
                    {/* Lien */}
                    <span className="inline-flex items-center gap-1 text-[#D97706] text-sm font-medium group-hover:gap-2 transition-all">
                      En savoir plus
        ...
        <div className="text-center mt-12">
          <Button
            asChild
            size="lg"
            className="bg-[#1C2B3A] hover:bg-[#2D3F52] text-white font-bold shadow-md"
          >
