...
import { HardHat, GitBranch, Mountain, TreePine, Shield } from "lucide-react"
...
export const metadata: Metadata = {
  ...
  description:
    "Découvrez toutes nos prestations : terrassement, VRD, enrochement, aménagement paysager et renforcement de fondations dans le Var (83). Devis gratuit.",
  alternates: { canonical: `${COMPANY.siteUrl}/services` },
  openGraph: {
    title: "Services — Concaterra Terrassement Var (83)",
    description:
      "Terrassement, VRD, enrochement, aménagement paysager et renforcement de fondations dans le Var.",
                ...
                >
                  <Card className="h-full border-2 border-transparent hover:border-[#D42020] transition-all duration-200">
                    <CardHeader>
                      ...
                      <CardTitle className="font-barlow-condensed font-bold text-xl text-[#57A639] uppercase group-hover:text-[#D42020] transition-colors">
                        {service.title}
                      </CardTitle>
                    </CardHeader>
                    <CardContent>
        ...
        <section className="py-16 bg-white border-t border-gray-100">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-gray-600 mb-6 max-w-lg mx-auto">
              Contactez-nous pour étudier votre projet. Réponse sous 24h ouvrables — devis sous 1 semaine,
